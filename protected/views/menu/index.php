                            ...
                            ?>  
	                                <div id="menu_list" class="menu-list" >
	                                    <div class="menu-setting">
	                                        ...
	                                        <span onclick="edit(this)" class="span-edit" id="<?php echo $m['id']?>" title="<?php echo $m['name']?>">&nbsp;edit</span>
	                                        <?php
		                                        if ($m['sub_count'] == 5) {
                                        	?>
		                            ...
		                            ?>
			                                <div id="menu_list" class="menu-list" >
			                                    <div class="menu-setting">
			                                        <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $mo['name']?></span>
			                                        <span onclick="delMenu(this)" class="del" title="<?php echo $mo['id']?>">&nbsp;del&nbsp;</span>
			                                        <span onclick="edit(this)" class="span-edit" id="<?php echo $mo['id']?>" title="<?php echo $mo['name']?>">&nbsp;edit</span>
			                                    </div>
			            					</div>
		                            <?php
		                                }
