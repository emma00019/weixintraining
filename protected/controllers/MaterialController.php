...
class MaterialController extends Controller
{
	...
	{
		$scene_str = Yii::app()->request->getParam('scene_str');

		$models = QrcodeMaterial::model()->findAllBySql("select * from tbl_qrcode_material where scene_str = :scene_str",array(':scene_str'=>$scene_str));
		$allModels = new Material('search');
